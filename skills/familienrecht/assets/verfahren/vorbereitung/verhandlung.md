---
title: "Vorbereitung Verhandlung"
lang: de-DE
fontsize: 11pt
linestretch: 1.3
geometry:
...
# Vorbereitung Verhandlung — Az. [Aktenzeichen]

## Verfahrensdaten
- **Termin:** [Datum, Uhrzeit]
- **Gericht:** [Gericht, Saal]
- **Richterin/Richter:** [Name]
- **Verfahrensbeistand:** [Name]
- **Gegenanwalt/-anwältin:** [Name]

---

## Kernbotschaften (max. 3)

1. [Wichtigste Botschaft]
2. [Zweitwichtigste Botschaft]
3. [Drittwichtigste Botschaft]

---

## Punkte aus dem Schriftsatz (Kurzfassung)
...
→ Siehe `erwiderung/nur-muendlich.md` für Details und Redevorschläge.

| Punkt | Wann vorbringen | Redevorschlag |
|-------|----------------|---------------|
| | Wenn Richterin fragt nach... | „..." |
| | Wenn Gegenseite behauptet... | „..." |

---

## Erwartbare Fragen der Richterin

| Frage | Antwortvorschlag |
|-------|-----------------|
| „Wie stellen Sie sich die Betreuung konkret vor?" | |
| „Warum sind Sie gegen das Residenzmodell?" | |
| „Wie gehen Sie mit den geschilderten Symptomen um?" | |

---

## Erwartbare Argumente der Gegenseite

| Argument | Reaktion |
|----------|----------|
| „Das Kind leidet unter dem Wechselmodell" | |
| „Die Vereinbarung wurde unter Druck unterzeichnet" | |
| „Der Vater war beruflich oft abwesend" | |
...
### Don't:
- Die Mutter/den Vater angreifen
- Emotional werden
- Unterbrechen
